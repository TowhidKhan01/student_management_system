...
<head>
  <meta charset="utf-8">
    ...
    <title>PCI Admin - Registration </title>
								  ...
								  <div class="row">
									<div class="col-12">
									  <div class="checkbox text-white">
										...
										<label for="basic_checkbox_1">I agree to the <a target="_blank" href="'.route('terms.show') class="text-warning"><b>Terms</b></a></label>
									  </div>
									</div>
									<!-- /.col -->
